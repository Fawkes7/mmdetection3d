...
def make_cuda_ext(name,
    ...
    define_macros = []
    extra_compile_args = {'cxx': ['-O3', '-g'] + extra_args}
...
if __name__ == '__main__':
    setup(
        ...
        ext_modules=[
            ...
            make_cuda_ext(
                name='voxel_layer',
                extra_include_path=[os.path.abspath('mmdet3d/ops/include/'), ],
            ...
            make_cuda_ext(
                ...
                sources_cuda=['src/three_interpolate_cuda.cu', 'src/three_nn_cuda.cu', 'src/trilinear_devox_cuda.cu']),
            make_cuda_ext(
            ...
            make_cuda_ext(
                name='point_group_ext',
                module='mmdet3d.ops.pointgroup',
                sources=[
            ...
            make_cuda_ext(
                name='emd_ext',
                module='mmdet3d.ops.emd',
                sources=['src/emd.cpp'],
                sources_cuda=['src/emd_kernel.cu'])
        ],
