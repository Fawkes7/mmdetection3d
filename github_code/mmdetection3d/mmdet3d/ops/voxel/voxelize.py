...
from .voxel_layer import dynamic_voxelize, hard_voxelize, avg_voxelize_forward, avg_voxelize_backward
...
class AvgVoxelization(Function):
    ...
    def forward(ctx, features, coords, resolution):
        ...
        out, indices, counts = avg_voxelize_forward(features, coords, resolution)
    ...
    def backward(ctx, grad_output):
        ...
        grad_features = avg_voxelize_backward(grad_output.contiguous().view(b, c, -1), indices, counts)
