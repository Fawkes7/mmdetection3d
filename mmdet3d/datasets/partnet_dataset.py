...
class PartNetDataset(Custom3DDataset):
    ...
    This class serves as the API for experiments on the PartNet Dataset.

    Please refer to the `github repo <https://github.com/daerduoCarey/partnet_dataset/>`_
    ...
    Args:
        ...
        test_mode (bool, optional): Whether the dataset is in test mode.
            Defaults to False.
    """
    CLASSES = ('bag', 'bed', 'bottle', 'bowl', 'chair', 'clock', 'dishwasher', 'display', 'door', 'earphone',
        ...
        Returns:
            dict: annotation information consists of the following keys:
                ...
                - gt_bboxes_3d (:obj:`DepthInstance3DBoxes`): \
                    ...
                    # obtained from CGAL5.1 Optimal_bounding_box
                - gt_labels_3d (np.ndarray): Labels of ground truths parts.
